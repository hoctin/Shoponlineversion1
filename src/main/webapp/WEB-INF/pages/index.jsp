...
<body>
			...
			<div class="row">
					...
					<div class="single-product-widget">
						...
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="<c:url value="/resources/img/product-thumb-1.jpg"/>" alt=""
						...
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="<c:url value="/resources/img/product-thumb-2.jpg"/>" alt=""
								class="product-thumb"></a>
							<h2>
						...
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="<c:url value="/resources/img/product-thumb-3.jpg"/>" alt=""
								class="product-thumb"></a>
							<h2>
				...
				<div class="col-md-4">
					<div class="single-product-widget">
						...
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="<c:url value="/resources/img/product-thumb-4.jpg"/>" alt=""
								class="product-thumb"></a>
							<h2>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/js/bxslider.min.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/resources/js/script.slider.js" />"></script>
</body>
</html>